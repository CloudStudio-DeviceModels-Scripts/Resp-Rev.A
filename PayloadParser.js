function parseUplink(device, payload)
{
    ...
    if (jsonPayload.sensorMessages) {
        ...
        var temperatureSensor2 = device.endpoints.byAddress(1);
        var temperatureSensor3 = device.endpoints.byAddress(1);
        var temperatureSensor4 = device.endpoints.byAddress(1);
