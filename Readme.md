...
# Parsing + Configuration Script – Resp - Rev. A

This **Parsing + Configuration** script is designed for the **Resp** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – Resp Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **Resp** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
